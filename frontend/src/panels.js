...
export const FeishuBotPanel = {
  ...
  template: `<section class="workspace-page"><header class="surface-header"><div><span class="eyebrow">协同中心 / 消息触达</span><h1>协同入口</h1><p>将当前分析会话绑定到飞书群，群内 @ 机器人可直接运行同一个 Agent。</p></div><StatusPill v-if="status" :status="connectionState"/></header>
