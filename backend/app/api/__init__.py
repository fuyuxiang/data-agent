...
from app.api import annotations, auth, data_sources, datasets, queries, history, system
...
router.include_router(annotations.router, prefix="/annotations", tags=["智能标注"])
